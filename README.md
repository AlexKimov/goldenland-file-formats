...
Часть действий персонажей (диалоги) вынесена в отдельные файлы с расширением script.

### Параметры и даннные

Информация о предматах, оружии, доспехах находится в файлах itd.
