...
| 4 | [itd.py](/plugins/gimp/itd.py) | Gimp | Просмотр изображений из файлов .itd  Златогорье 1 |
    ...
    1. Поместить плагин в папку Users\"Имя текущего пользователя"\AppData\Roaming\GIMP\2.10\plug-ins , где "Имя текущего пользователя" заенить на имя текущего пользователя
    2. Запустить, открыть файл через меню файл-открыть.  

    Как установить плагин для Tiled
    1. Поместить все файлы плагина в папку Users\"Имя текущего пользователя"\AppData\Local\Tiled\extension.
